...
class Contact extends Component 
{
    ...
    handleInputChange(event) 
    {
        ...
        const currentValue = currentTarget.type === 'checkbox' ? currentTarget.checked : currentTarget.value;
    ...
    validate(firstname, lastname, telnum, email)
    {
        ...
        const reg = /^\d+$/; //regular expression
        if(this.state.touched.telnum && !reg.test(telnum))    
            errors.telnum = 'Tel Num must only contain numbers' ; 

        if(this.state.touched.email && email.split('').filter(x=>x ==='@').length !==1)
            errors.email = 'Email must have one @ sign';   
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="lastname" name="lastname" placeholder="lastname" value={this.state.lastname} valid={errors.lastname === ''} invalid={errors.lastname !== ''} onBlur={this.handleBlur('lastname')} onChange={this.handleInputChange}/>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="email" id="email" name="email" placeholder="Email ID" value={this.state.email} valid={errors.email === ''} invalid={errors.email !== ''} onBlur={this.handleBlur('email')} onChange={this.handleInputChange}/>
